...
def trigger():
    ...
    sync_facade.sync(test_constant.LOCAL_PATH_ROOT, test_constant.CLOUD_PATH_ROOT, test_constant.SWAP_PATH_ROOT, True, test_constant.TD_MODE_MASTER, latest_index, test_constant.BASE_UPLOAD_CLOUD_DB_GAP)

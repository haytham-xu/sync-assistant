...
#     assert cloud_file_service.is_exist(path_support.merge_path([test_constant.CLOUD_PATH_ROOT, test_constant.TD_MIDDLE_DELETE])) == True
...
#     assert path_support.is_exist(path_support.merge_path([test_constant.LOCAL_PATH_ROOT, test_constant.TD_MIDDLE_DELETE])) == True

...
def init_test_environment():
    ...
    test_support.local_create_store_file(test_constant.TD_MIDDLE_UPDATE, test_constant.TD_CONTENT_DEFAULT, local_db, True, test_constant.TD_OLDTIEM)
    ...
    test_support.local_create_store_file(test_constant.TD_MIDDLE_DELETE, test_constant.TD_CONTENT_DEFAULT, local_db, True, test_constant.TD_OLDTIEM)
    ...
    test_support.cloud_create_store_file(test_constant.TD_MIDDLE_CREATE, test_constant.TD_CONTENT_DEFAULT, mock_cloud_db, True, test_constant.TD_NEWTIME)
    test_support.cloud_create_store_file(test_constant.TD_MIDDLE_UPDATE, test_constant.TD_CONTENT_UPDATE, mock_cloud_db, True, test_constant.TD_NEWTIME)
...
def trigger():
    ...
    latest_index = test_support.build_indexs([
        ...
        test_support.build_index(test_constant.TD_MIDDLE_DELETE, test_constant.TD_OLDTIEM, True),

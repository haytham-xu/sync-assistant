...
def init_test_environment():
    ...
    test_support.local_create_store_file(test_constant.TD_MIDDLE_CREATE, test_constant.TD_CONTENT_DEFAULT, local_db, False, test_constant.TD_NEWTIME)
    test_support.local_create_store_file(test_constant.TD_MIDDLE_UPDATE, test_constant.TD_CONTENT_UPDATE, local_db, False, test_constant.TD_NEWTIME)
    ...
    test_support.cloud_create_store_file(test_constant.TD_MIDDLE_UPDATE, test_constant.TD_CONTENT_DEFAULT, mock_cloud_db, False, test_constant.TD_OLDTIEM)
    ...
    test_support.cloud_create_store_file(test_constant.TD_MIDDLE_DELETE, test_constant.TD_CONTENT_DEFAULT, mock_cloud_db, False, test_constant.TD_OLDTIEM)
...
def trigger():
    ...
    sync_facade.sync(test_constant.LOCAL_PATH_ROOT, test_constant.CLOUD_PATH_ROOT, test_constant.SWAP_PATH_ROOT, False, test_constant.TD_MODE_MASTER, latest_index, test_constant.BASE_UPLOAD_CLOUD_DB_GAP)

...
def sync(local_base_path:str, cloud_base_path:str, swap_base_path:str, encrypt:bool, mode:str, latest_index:dict={}, upload_cloud_db_gap:int=10):
    ...
    if mode == "master":
        sync_push(folder_context, encrypt, latest_index, upload_cloud_db_gap)
    else:
        sync_pull(folder_context, encrypt, latest_index)
    buffer_service.remove_buffer_folder(folder_context)

def sync_push(folder_context:context_model.FolderContext, encrypt:bool, latest_index:dict, upload_cloud_db_gap:int=10):
    ...
    handler_facade.handle_cloud_delete(should_delete_in_cloud, swap_db, upload_cloud_db_gap)
